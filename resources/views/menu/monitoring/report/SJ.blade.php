...
@endphp
    @if($data)
        <h2  style="margin-top: -15px;margin-bottom: 5px;text-align: center;">
            <b>DAFTAR STRUK PESANAN BARANG / SURAT JALAN</b>
        </h2>
            <h5 style="font-size:8px;text-align:center; margin:0px;"><b>No.&nbsp; : {{$data->data->header[0]->nodspb}}</b></h5>
            <h5 style="font-size:8px;text-align:center; margin:0px;"><b>Tgl&nbsp; : {{date('d-m-Y',strtotime($data->data->header[0]->tglpb))}}</b></h5>
            <br>
            <h5 style="font-size:8px;text-align:center; margin:0px;"><b>{{$data->data->label}}</b></h5>
        ...
        <table style="text-align:left;">
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;"><b>{{$data->data->header[0]->nopb}}</b></td>
                        </tr>
                        <tr>
